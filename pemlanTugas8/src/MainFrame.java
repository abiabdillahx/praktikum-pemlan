...
//     JTextField tfNamaLengkap;
//     JTextField tfTanggalLahir;

//     public void initialize() {
//         // Form Panel
//         JLabel lbNamaLengkap = new JLabel("Nama Lengkap");
//         lbNamaLengkap.setFont(mainFont);

//         tfNamaLengkap = new JTextField();
//         tfNamaLengkap.setFont(mainFont);

//         JLabel lbTanggalLahir = new JLabel("Tanggal Lahir");
//         lbTanggalLahir.setFont(mainFont);

//         tfTanggalLahir = new JTextField();
//         tfTanggalLahir.setFont(mainFont);

//         JPanel formPanel = new JPanel();
//         formPanel.setLayout(new GridLayout(4, 1, 5, 5));
//         formPanel.add(lbNamaLengkap);
//         formPanel.add(tfNamaLengkap);
//         formPanel.add(lbTanggalLahir);
