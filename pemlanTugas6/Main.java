public class Main {
    public static void main(String[] args) {
        ...
        Manusia b = new Manusia("Alice", "112", false, true);
        ...
        // 2. MahasiswaFILKOM
        // a. Ipk < 3
        MahasiswaFILKOM d = new MahasiswaFILKOM("245150701111027", 2.9, "Abi", "222", true, false);
        ...
        // c. Ipk 3.5 – 4
        MahasiswaFILKOM f = new MahasiswaFILKOM("245150701111029", 3.8, "Cici", "224", false, true);
        ...
        Pekerja g = new Pekerja(1000, 2021, 3, 2, 2, "D", "111", true, true);
        System.out.println(g);
        System.out.println();

        // b. Lama bekerja 9 tahun
        Pekerja h = new Pekerja(1000, 2014, 3, 2, 0, "E", "112", false, false);
        System.out.println(h);
        System.out.println();

        // c. Lama bekerja 20 tahun, anak 10
        Pekerja i = new Pekerja(1000, 2001, 3, 2, 10, "F", "113", true, true);
